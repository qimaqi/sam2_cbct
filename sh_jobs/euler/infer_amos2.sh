...
#   --output_mask_dir ./outputs/amos_freeze_pred_point_all \
#   --use_all_masks \
...
#   --input_mask_dir /cluster/work/cvl/qimaqi/miccai_2025/Dataset219_AMOS2022_videos/train/Annotations \
#   --video_list_file /cluster/work/cvl/qimaqi/miccai_2025/Dataset219_AMOS2022_videos/train/eval_fold_0.txt  \
#   --output_mask_dir ./outputs/amos_finetune_freeze_image_point_all \
#   --use_all_masks \
#   --track_object_appearing_later_in_video \
#   --point_prompt 
...
python ./tools/vos_inference.py \
  ...
  --input_mask_dir /cluster/work/cvl/qimaqi/miccai_2025/Dataset219_AMOS2022_videos/train/Annotations \
  --video_list_file /cluster/work/cvl/qimaqi/miccai_2025/Dataset219_AMOS2022_videos/train/eval_fold_0.txt  \
  --output_mask_dir ./outputs/amos_finetune_jointly_point1_all \
  --use_all_masks \
  --track_object_appearing_later_in_video \
  --point_prompt 
